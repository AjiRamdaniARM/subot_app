...
<br>
<br>
<img src="{{ asset('assets/image/logorbtikasli.png') }}" alt="">
<br>
<br>
<form class="max-w-sm mx-auto">
    ...
    <div class="flex justify-center mb-5">
      <a href="{{ url('/jd') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-20 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</a>
  </div>  
  </form>
