     ...
     <button id="closeSideBar" class="md:hidden hover:105 transition-all lg:hidden block w-full text-end p-5 absolute poppins-regular">Keluar</button>
        <div class="p-10">
            ...
            <ul class="mt-10 flex flex-col gap-3">
                {{-- === menu beranda === --}}
                <li><a href="#" class="block py-2 px-4 {{ request()->routeIs('home') ? 'text-[#0B235E] fw-[500]' : 'text-[#798AA3] fw-[400]' }} flex items-center gap-3">
                    <span>                    
                 ...
                 {{-- === menu akun === --}}
                <li><a href="#" class="block py-2 px-4  {{ request()->routeIs('') ? 'text-[#0B235E] fw-[500]' : 'text-[#798AA3] fw-[400]' }} flex items-center gap-3">
                        <span>                    
