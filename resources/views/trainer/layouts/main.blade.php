...
<div class="flex">
     ...
     <button id="closeSideBar" class="md:hidden hover:105 transition-all lg:hidden block w-full text-end p-5 absolute poppins-regular">Keluar</button>
        <div class="p-10">
            ...
            <ul class="mt-10 flex flex-col gap-3">
                {{-- === menu beranda === --}}
                <li><a href="{{route('home')}}" class="block hover:bg-gray-200 hover:scale-105 hover:rounded-lg py-2 px-4 {{ request()->routeIs('home') ? 'text-[#0B235E] fw-[500]' : 'text-[#798AA3] fw-[400]' }} flex items-center gap-3">
                    <span>                    
                 ...
                 {{-- === menu akun === --}}
                <li><a href="{{route('akun')}}" class="block py-2 px-4 hover:bg-gray-200 hover:scale-105 hover:rounded-lg  {{ request()->routeIs('akun') ? 'text-[#0B235E] fw-[500]' : 'text-[#798AA3] fw-[400]' }} flex items-center gap-3">
                        <span>                    
    ...
    <div class="flex-1 md:ml-64 lg:ml-64 ml-0 p-4 ">
        ...
        <main class=" md:px-5 px-1 lg:px-5 py-10">
            @yield('children')
        </main>
    </div> 
</div>
