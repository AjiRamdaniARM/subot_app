  ...
  <main class="home">
              ...
              <ul>
                <li>
                  <a href="../components/splash-screen.html">
                    <div class="d-flex align-items-center gap-16">
                      <span class="icon">
                        <img src="{{ asset('assets/trainerSvg/svg/menu/box-white.svg') }}" alt="icon">
                      </span>
                      splash screen
                    </div>
                  </a>
    ...
    <section class="info d-flex align-items-start justify-content-between pb-12">
      ...
      <ul class="d-flex align-items-center gap-16">
        <li>
          <a href="{{ asset('/notifications') }}" class="d-flex align-items-center justify-content-center rounded-full position-relative">
            <img src="{{ asset('assets/trainerSvg/svg/bell-black.svg') }}" alt="icon">
            <span class="dot"></span>
          </a>
        </li>
        <li>
          <a href="{{ url('/pesan') }}" class="d-flex align-items-center justify-content-center rounded-full position-relative">
    ...
    <main>
      ...
      <section class="service py-12">
        <div class="container">
          ...
          <div class="d-flex justify-content-center">
            <!-- item 1 -->
            <a href="{{ url('/jadwal') }}" class="text-decoration-none mx-3">
              <figure class="item text-center">
                <div class="image rounded-full d-flex align-items-center justify-content-center m-auto">
                  <img src="{{ asset('assets/img/kalender.png') }}" alt="airport" class="img-fluid backface-hidden">
                </div>
            ...
            <!-- item 2 -->
            <a href="{{ url('/instruktur') }}" class="text-decoration-none mx-3">
              <figure class="item text-center">
                <div class="image rounded-full d-flex align-items-center justify-content-center m-auto">
                  <img src="{{ asset('assets/img/group.png') }}" alt="car" class="img-fluid backface-hidden">
                </div>
            ...
            <!-- item 3 -->
            <a href="{{ url('/historyabsen') }}" class="text-decoration-none mx-3">
              <figure class="item text-center">
                <div class="image rounded-full d-flex align-items-center justify-content-center m-auto">
                  <img src="{{ asset('assets/img/menuabsen.gif') }}" alt="hotel" class="img-fluid backface-hidden">
                </div>
      ...
      <style>
        .service {
          ...
          align-items: center;
          flex-wrap: wrap; /* Jika ingin item-item ini wrap ketika ukuran layar kecil */
        }
        ...
        .pt-8 {
          padding-top: 0.5rem; /* Adjust top padding for budget section */
        }
      </style>
      <!-- Menu end -->
          ...
          <a href="" class="text-decoration-none">
            ...
            <div class="content mt-2">
              ...
              <p class="location d-flex align-items-center gap-2">
                <img src="{{ asset('assets/trainerSvg/svg/map-marker.svg') }}" alt="icon" class="me-1">
                Sukabumi, Nusa Putra
              </p>
            </div>
          </a>
