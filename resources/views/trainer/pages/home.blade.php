            ...
            <div class="body  py-10">
                <div class="content">
                    <div  class="card-1 flex flex-col gap-5">
                        ...
                        @php
                            $jdBaru = DB::table('schedules')
                                ->where('ket', 'Aktif')
                                    ->where('ab_trainer', '=', null)
                                ->exists();
                        @endphp
                       @if ($getScheduleTrainer !== null && !$getScheduleTrainer->isEmpty() && $jdBaru)
                       ...
                       @if ($getScheduleTrainer !== null && !$getScheduleTrainer->isEmpty() && $jdSudahAbsen) 
                        ...
                        <div class="text-[#798AA3]"> Jadwal tidak aktif</div>
                            @php
                            $jdTidakAktif = DB::table('schedules')
                                ->where('ket', 'Tidak Aktif')
                                    ->where('ab_trainer', '=', 'Tidak Hadir')
                                ->exists();
                            @endphp
                            @if ($getScheduleTrainer !== null && $getScheduleTrainer->isNotEmpty() && $jdTidakAktif)
                                @foreach ($getScheduleTrainer as $jadwal)
