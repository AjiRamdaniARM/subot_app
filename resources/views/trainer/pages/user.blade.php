...
@section('children')
    ...
    <body class="scrollbar-hidden">
        ...
        <main class="user-profile">
            ...
            <section class="user-profile-heading d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-12">
                    <div class="image rounded-full overflow-hidden shrink-0">
                        <img src="{{ asset('assets/img/robot.png') }}" alt="avatar"
                ...
                <a href="#" class="edit-info" onclick="showAlert(); return false;">
            ...
            <!-- Alamat-heading end -->
            <div class="py-16">
                <button type="button" class="btn-primary-outline btn-with-hover" data-bs-toggle="modal"
                    data-bs-target="#alamat">Alamat</button>
            </div>
            <!-- Alamat-heading end -->
            ...
            <div class="py-16">
                <button type="button" class="btn-primary-outline btn-with-hover" data-bs-toggle="modal"
                    data-bs-target="#Lulusan">Lulusan</button>
            </div>
            <!-- Lulusan-heading end -->
            ...
            <div class="py-16">
                <button type="button" class="btn-primary-outline btn-with-hover" data-bs-toggle="modal"
                    data-bs-target="#Telephone">Telephone</button>
            </div>
            <!-- Telephone-heading end -->
            ...
            <div class="py-16">
                <button type="button" class="btn-primary-outline" data-bs-toggle="modal" data-bs-target="#fotoktp">Foto
                    Ktp</button>
            </div>
            <!-- Foto Ktp-heading end -->
            ...
            <div class="py-16">
                <button type="button" class="btn-primary-outline" data-bs-toggle="modal" data-bs-target="#ttd">Tanda
                    Tangan</button>
            </div>
            <!--Foto Ttd-heading end-->
            ...
            <div class="py-16">
                <button type="button" class="btn-primary-outline"
                    style="background-color: rgb(190, 0, 0); color: white; font-weight: 600;" data-bs-toggle="modal"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header justify-content-end">
                        <button type="button"
                            class="close-btn d-flex align-items-center justify-content-center rounded-full"
                    ...
                    <div class="modal-body text-center">
                        ...
                        <ul>
                            <li class="mb-4">
                                <input type="text" id="cancelInput" class="form-control"
                                    placeholder="Jl.Pabuaran Rt.04/01 Kota Sukabumi">
                            </li>

                            <li>
                                <button type="button" class="log-out" data-bs-dismiss="modal" aria-label="Close"
                                    style="background-color: rgb(41, 116, 255); color: white;">Confirm</button>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <ul>
                            <li class="mb-4">
                                <img src="{{ asset('assets/img/Ochobot aesthetic.jpeg') }}" alt="Small Image"
