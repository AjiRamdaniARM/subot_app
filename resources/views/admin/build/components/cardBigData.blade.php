            ...
            <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                    <div class="flex-none w-2/3 max-w-full px-3">
                        <div>
                            <p class="mb-0 font-sans text-sm font-semibold leading-normal">All Data School</p>
                            <h5 class="mb-0 font-bold">
                                {{ $getDataSekolahCount }}
                                <span
                                    class="text-sm leading-normal font-weight-bolder text-lime-500">+{{ $activePercentage }}%</span>
                            </h5>
                        </div>
                    </div>
