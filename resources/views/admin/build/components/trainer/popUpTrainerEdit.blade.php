        ...
        <form action="{{ url('/dataTrainer/edit/'.$trainerGet->nama) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grup-1">
              <label for="inp" class="inp">
                <input id="inp" type="text" name="nama" placeholder="&nbsp;" value="{{$trainerGet->nama}}" required />
                <span class="label">Full Name</span>
                <span class="focus-bg"></span>
              </label>

              <label for="inp" class="inp">
                <input id="inp" type="text" name="alamat" placeholder="&nbsp;" value="{{$trainerGet->alamat}}" />
                <span class="label">Full Address Trainer</span>
                <span class="focus-bg"></span>
              </label>

              <label for="inp" class="inp">
                <input id="inp" type="text" name="lulusan" placeholder="&nbsp;" value="{{$trainerGet->lulusan}}" required />
